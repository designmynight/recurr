...
class Rule
{
    ...
    protected Carbon|\DateTimeImmutable|null $startDate = null;

    protected Carbon|\DateTimeImmutable|null $endDate = null;
    ...
    protected Carbon|\DateTimeImmutable|null $until = null;
    ...
    public function __construct(
        ...
        Carbon|\DateTimeImmutable|string|null $startDate = null,
        Carbon|\DateTimeImmutable|string|null $endDate = null,
     ...
     *
     * @param Carbon|\DateTimeImmutable $startDate Date of the first occurrence in the recurrence
     * @param bool|null $includeInString If true, include date as DTSTART when calling getString()
     */
    public function setStartDate(Carbon|\DateTimeImmutable $startDate, ?bool $includeInString = null): static
    {
    ...
    public function getStartDate(): Carbon|\DateTimeImmutable|null
    {
     ...
     */
    public function setEndDate(Carbon|\DateTimeImmutable|null $endDate): static
    {
    ...
    public function getEndDate(): Carbon|\DateTimeImmutable|null
    {
        return $this->endDate;
    }
     ...
     */
    public function setUntil(Carbon|\DateTimeImmutable|null $until): static
    {
        $this->until = $until;
        $this->count = null;
    ...
    public function getUntil(): Carbon|\DateTimeImmutable|null
    {
        $date = $this->until;
     ...
     */
    private function convertZtoUtc(Carbon|\DateTimeImmutable $date): Carbon|\DateTimeImmutable
    {
