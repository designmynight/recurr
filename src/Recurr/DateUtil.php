...
class DateUtil
{
    ...
    public static function getDateInfo(Carbon|\DateTimeImmutable $dt): DateInfo
    {
        $i = new DateInfo();
        $i->dt = $dt;
    ...
    public static function getDaySet(Rule $rule, Carbon|\DateTimeImmutable $dt, DateInfo $dtInfo): DaySet
    {
    ...
    public static function getDaySetOfYear(Carbon|\DateTimeImmutable $dt): DaySet
    {
    ...
    public static function getDaySetOfMonth(Carbon|\DateTimeImmutable $dt): DaySet
    {
    ...
    public static function getDaySetOfDay(Carbon|\DateTimeImmutable $dt): DaySet
    {
     ...
     * @return Time[]
     */
    public static function getTimeSetOfHour(Rule $rule, Carbon|\DateTimeImmutable $dt): array
    {
        $set = [];
     ...
     * @return Time[]
     */
    public static function getTimeSetOfMinute(Rule $rule, Carbon|\DateTimeImmutable $dt): array
    {
        $set = [];
     ...
     * @return Time[]
     */
    public static function getTimeSetOfSecond(Carbon|\DateTimeImmutable $dt): array
    {
     ...
     * @return Time[]
     */
    public static function getTimeSet(Rule $rule, Carbon|\DateTimeImmutable $dt): array
    {
        $set = [];
     ...
     */
    public static function getMonthDaysMask(Carbon|\DateTimeImmutable $dt, bool $negative = false): array
    {
        if ($negative) {
            $m29 = range(-29, -1);
            $m30 = range(-30, -1);
     ...
     */
    public static function getMonthMask(Carbon|\DateTimeImmutable $dt): array
    {
        if (self::isLeapYearDate($dt)) {
            return array_merge(
    ...
    public static function isLeapYearDate(Carbon|\DateTimeImmutable $dt): bool
    {
     ...
     */
    public static function getDayOfWeekAsText(Carbon|\DateTimeImmutable $dt): string
    {
     ...
     */
    public static function getDayOfWeek(Carbon|\DateTimeImmutable $dt): int
    {
     ...
     */
    public static function getYearLength(Carbon|\DateTimeImmutable $dt): int
    {
